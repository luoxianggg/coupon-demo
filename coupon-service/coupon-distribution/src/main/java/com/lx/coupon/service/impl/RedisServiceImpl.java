...
import com.lx.coupon.constant.Constant;
...
import com.lx.coupon.service.IRedisService;
...
public class RedisServiceImpl implements IRedisService {
     ...
     * @param userId 用户 id
     * @param status 优惠券状态 {@link com.lx.coupon.constant.CouponStatus}
     * @return {@link com.lx.coupon.entity.Coupon}s, 注意, 可能会返回 null, 代表从没有过记录
     */
    @Override
    ...
    public void saveEmptyCouponListToCache(Long userId, List<Integer> status) {
        ...
        // 使用 SessionCallback 把数据命令放入到 Redis 的 pipeline(一次性执行多条redis命令)
